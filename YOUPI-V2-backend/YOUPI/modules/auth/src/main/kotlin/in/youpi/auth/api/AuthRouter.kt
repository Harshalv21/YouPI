    ...
    @RouterOperations(
        RouterOperation(path = "/v1/auth/otp/send", method = [RequestMethod.POST],
            operation = Operation(operationId = "sendOtp", summary = "Send OTP to mobile",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = SendOtpRequest::class))]),
        ...
        RouterOperation(path = "/v1/auth/otp/verify", method = [RequestMethod.POST],
            operation = Operation(operationId = "verifyOtp", summary = "Verify OTP",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = VerifyOtpRequest::class))]),
        ...
        RouterOperation(path = "/v1/auth/mpin/setup", method = [RequestMethod.POST],
            operation = Operation(operationId = "setupMpin", summary = "Setup MPIN",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = MpinSetupRequest::class))]),
        ...
        RouterOperation(path = "/v1/auth/mpin/verify", method = [RequestMethod.POST],
            operation = Operation(operationId = "verifyMpin", summary = "Verify MPIN",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = MpinVerifyRequest::class))]),
        ...
        RouterOperation(path = "/v1/auth/token/refresh", method = [RequestMethod.POST],
            operation = Operation(operationId = "refreshToken", summary = "Refresh access token",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = RefreshTokenRequest::class))]),
        ...
        RouterOperation(path = "/v1/auth/firebase/verify", method = [RequestMethod.POST],
            operation = Operation(operationId = "verifyFirebaseToken", summary = "Verify Firebase ID token",
                ...
                tags = ["Auth"],
                requestBody = SwaggerRequestBody(content = [Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = Schema(implementation = FirebaseVerifyRequest::class))]),
